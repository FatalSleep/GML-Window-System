///ScrDrawSurfaceExt( surface, xpos, ypos, xscale, yscale, xorigin, yorigin, angle, blend, alpha )
   // DESCRIPTION: Draws a surface with with various modifiers.
   var Surface = argument[$00],
      Xpos = argument[$01],
      Ypos = argument[$02],
      Xscale = argument[$03],
      Yscale = argument[$04],
